...
CREATE TABLE orders(id BIGINT GENERATED BY DEFAULT AS IDENTITY, order_date DATETIME(6), fk_accounts_id BIGINT NOT NULL, FOREIGN KEY (fk_accounts_id) REFERENCES accounts (id) ON DELETE CASCADE);
